...
uint8_t seg_text_64[] = {
    ...
    0xbe, 0xb0, 0x00, 0x40, 0x00,  // movabs $0x4000b0,%rsi
...
uint8_t seg_text_32[] = {
    ...
    0xb9, 0x74, 0x80, 0x04, 0x08,  // mov    $0x8048074,%ecx
    0xba, 0x0d, 0x00, 0x00, 0x00,  // mov    $0xd,%edx
    0xcd, 0x80,                    // int    $0x80
    0xb8, 0x01, 0x00, 0x00, 0x00,  // mov    $0x1,%eax
...
#define data_offset_64 (sizeof(Elf64_Ehdr) + 2 * sizeof(Elf64_Phdr))
#define text_offset_64 (data_offset_64 + sizeof(seg_data))

#define entry_32 0x8048000
#define data_offset_32 (sizeof(Elf32_Ehdr) + 2 * sizeof(Elf32_Phdr))
...
Elf64_Phdr phdr_data_64 = {
    .p_type   = PT_LOAD,
    .p_flags  = PF_R,
    .p_offset = data_offset_64,
    .p_vaddr  = entry_64 + data_offset_64,
    .p_paddr  = entry_64 + data_offset_64,
    .p_filesz = sizeof(seg_data),
    .p_memsz  = sizeof(seg_data),
    .p_align  = 0x1000,
};

Elf32_Phdr phdr_data_32 = {
    .p_type   = PT_LOAD,
    .p_flags  = PF_R,
...
Elf64_Phdr phdr_text_64 = {
    .p_type   = PT_LOAD,
    .p_flags  = PF_R | PF_X,
    .p_offset = text_offset_64,
    .p_vaddr  = entry_64 + text_offset_64,
    .p_paddr  = entry_64 + text_offset_64,
    .p_filesz = sizeof(seg_text_64),
    .p_memsz  = sizeof(seg_text_64),
    .p_align  = 0x1000,
};
...
Elf32_Phdr phdr_text_32 = {
    .p_type   = PT_LOAD,
    .p_flags  = PF_R | PF_X,
    .p_offset = text_offset_32,
    .p_vaddr  = entry_32 + text_offset_32,
    .p_paddr  = entry_32 + text_offset_32,
    .p_filesz = sizeof(seg_text_32),
    .p_memsz  = sizeof(seg_text_32),
    .p_align  = 0x1000,
};
...
int main(int argc, char* argv[]) {
  ...
  if (is_64) {
    ...
    fwrite(&phdr_data_64, 1, sizeof(phdr_data_64), output);
    ...
    fwrite(&phdr_data_32, 1, sizeof(phdr_data_32), output);
